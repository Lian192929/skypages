; window.CloudflareApps = window.CloudflareApps || {}; CloudflareApps.siteId = "a894708d9c8cb8ebc5d6e467c19937d4"; CloudflareApps.installs = CloudflareApps.installs || {};; (function () {
    'use strict'
        ...
        for (var installId in installs) {
            ...
            for (var key in selectors) {
                ...
                if (els && els.length > 1) {
                    ...
                    continue
                } else if (!els || !els.length) { continue }
                initializedSelectors[hash] = true
    ...
    CloudflareApps.querySelector = function querySelector(selector) {
        ...
        if (!els || !els.length) {
            ...
            if (!els || !els.length) {
                ...
                return null
            } else if (els.length > 1) { noteError({ type: 'select:too-many:by-query', selector: selector }) }
            return els[0]
        }
    ...
    CloudflareApps.createElement = function createElement(options, prevEl) {
        ...
        try {
            if (prevEl && prevEl.parentNode) {
                ...
                } else { prevEl.parentNode.removeChild(prevEl) }
            }
            ...
            switch (options.method) {
                case 'prepend': if (container.firstChild) {
